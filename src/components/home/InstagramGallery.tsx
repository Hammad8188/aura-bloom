const InstagramGallery = () => {
  const images = [
    ...
    'https://images.unsplash.com/photo-1592945403244-b3fbabd7f539?w=400',
  ...
  return (
    <section className="py-12 bg-muted/30">
      <div className="container mx-auto px-4 mb-8 text-center">
        <span className="text-primary text-sm tracking-widest">FOLLOW US</span>
        <h2 className="font-serif text-2xl md:text-3xl mt-2">@noiressence</h2>
      </div>
